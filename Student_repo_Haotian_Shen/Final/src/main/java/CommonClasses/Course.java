...
/*
Class CommonClass.Course contains information about a course (course name and course code), as well as information
...
public class Course {
  ...
  private final LocalDate yearTaken;
